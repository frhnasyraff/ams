$(document).ready(function () {
    ...
    const $assetCardContainer = $("#asset-card-container");
    ...
    function showPage(page, currentItemsPerPage, cardsToShow) {
        ...
        cardsToShow.slice(start, end).appendTo($assetCardContainer);
    }

    function filterAndPaginate() {
        const searchTerm = $searchInput.val().toLowerCase();
        filteredCards = $cards.filter(function () {
            return $(this).data("asset-type").includes(searchTerm);
        });
    ...
    $pagination.on("click", ".page-link", function (e) {
        ...
        updatePagination($cards.filter(function () {
            return $(this).data("asset-type").includes($searchInput.val().toLowerCase());
