			...
			*/
			{
				...
				createdCell: function (td, cellData, rowData, row, col) {
                    $(td).html(
                        ...
                        '<button type="button" class="btn btn-edit locations-action" data-id="' + rowData.id + '" title="Edit store location" aria-label="Edit"><i class="fas fa-pen" aria-hidden="true"></i> Edit</button>' +
                        '<button type="button" class="btn btn-delete locations-action" data-id="' + rowData.id + '" title="Delete store location" aria-label="Delete"><i class="fas fa-trash-alt" aria-hidden="true"></i> Delete</button>' +
                        '</div>'
                    );
				}
			}
