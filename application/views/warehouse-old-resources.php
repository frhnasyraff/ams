...
?>
<div class='alert alert-danger'>This is the old resource planning for the warehouse where planning is done by location and not by SSR. Please use the new resource planner.</div>
    ...
    <div class="row">
      <div class="col-sm-10">
        ...
        Number of gangs:
                                <?= $ssr->number_gangs; ?>
        <div class="text-info">
          <?= $ssr->work_meals ? '<span class="text-success">Working through meals.</span>' : '<span class="text-danger">Not working through meals.</span>'; ?>
        </div>
...
<form class="form-horizontal" action="<?=site_url("companies/save_resources_plan");?>" method="post">
  ...
  <input type="hidden" name="id" value="<?= $ssr->company_address_id; ?>" />
