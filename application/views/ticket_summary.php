<style>
    ...
    body:has(.ticket-summary-report-page) .ticket-summary-report-page .report-table-scroll {
        width: 100% !important;
        min-width: 0 !important;
        overflow: visible !important;
    }

    body:has(.ticket-summary-report-page) .ticket-summary-report-page .dataTables_wrapper {
        width: 100% !important;
        min-width: 0 !important;
    ...
    body:has(.ticket-summary-report-page) .ticket-summary-report-page .dataTables_scroll,
    body:has(.ticket-summary-report-page) .ticket-summary-report-page .dataTables_scrollHead,
    body:has(.ticket-summary-report-page) .ticket-summary-report-page .dataTables_scrollBody {
        width: 100% !important;
        min-width: 0 !important;
        max-width: 100% !important;
        box-sizing: border-box !important;
    ...
    body:has(.ticket-summary-report-page) .ticket-summary-report-page .dataTables_scrollHeadInner,
    body:has(.ticket-summary-report-page) .ticket-summary-report-page table.report-suite-table {
        min-width: 1700px !important;
    }

    body:has(.ticket-summary-report-page) .ticket-summary-report-page .report-dt-top,
    body:has(.ticket-summary-report-page) .ticket-summary-report-page .report-dt-bottom {
        width: 100% !important;
        min-width: 0 !important;
        box-sizing: border-box !important;
    }
...
<div class="report-suite-page ticket-summary-report-page" data-report-tone="ticket">
