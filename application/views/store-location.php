<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary bg-light">Store Location Directory
            ...
            <a class="float-right" href="#addModal" data-toggle="modal" data-target="#addModal"
                title="Add new store location"><i class="fa fa-plus"></i> New Store Location</a>
            <?php } ?>
        </h6>
    </div>
    <div class="card-body">
        <!-- Legacy state filters are not applicable because store_location has no state_id.
            ...
            <table
                ...
                <thead>
                    <tr>
                        <!-- <th>Country Name</th> -->
                        <th>Name</th>
                        <!-- Legacy columns (store_location only contains id, name and active):
                        <th>State </th>
                        <th>Latitude</th>
                        <th>Longitude</th>
                        -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">New Store Location
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" action="<?= site_url("StoreLocation/add"); ?>" method="post">
                <div class="container">
                    <div class="modal-body row">
                        ...
                        <!-- Legacy location-detail fields are not columns in store_location.
                        <div class="col-md-6 mb-4">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success">Add Store Location</button>
                ...
                <form id="editForm">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="state_name" id="stateName" class="form-control">
                        ...
                        <div class="col-md-6 mb-4">
                            <label for="">Latitude<sup style="color: red;">Required</sup></label>
                            <input class="form-control" type="number" id="lat" name="lat" placeholder="Latitude" min="-90" max="90" step="0.000001" required>
