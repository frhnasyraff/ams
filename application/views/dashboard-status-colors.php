...
<a class="float-right text_successo btn btn_border" href="#addModal" data-toggle="modal" data-target="#addModal"
    title="Add new Asset Type Color"><i class="fa fa-plus"></i>New Color</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Dashboard Status Color</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" action="<?= site_url("DashboardStatusColor/add"); ?>" method="post">
                <div class="modal-body">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-10">
                            <div class="form-group time_picker uppercase">
                                <label for="asset-type-name">Status Name<sup>REQUIRED</sup></label>
                            ...
                            <div class="form-group time_picker uppercase">
                                ...
                                <input type="color" name="status_color" class="form-control" placeholder="Color"
                                    required>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?= site_url("DashboardStatusColor/update"); ?>"
                id="asset_type_color_udpate_form" method="post">
                ...
                <div class="modal-body">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-md-10">
                            ...
                            <div class="form-group time_picker uppercase">
                                <label for="asset-type-name">Status Name<sup>REQUIRED</sup></label>
                                <input type="text" class="form-control" name="status_name" id="edit_status" placeholder="Status Name"
                                    required>
                            </div>
                            <div class="form-group time_picker uppercase">
                                <label for="asset-type-color">color in hex <sup>REQUIRED</sup></label>
                                <input type="color" name="status_color" class="form-control" id="edit_color" placeholder="Color"
